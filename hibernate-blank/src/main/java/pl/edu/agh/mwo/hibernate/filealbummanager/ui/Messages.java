...
public final class Messages {
    ...
    public static final String INVALID_INPUT_E2 = "[E2] input is not correct";
    ...
    public static final String RETRY_ALBUM = "Do you want to try again with new name? 1-yes, 2-no";
    public static final String INVALID_INPUT_E33 = "[E33] input is not correct";
    ...
    public static final String RETRY_PHOTO = "Would you like to try again to enter the name of the photo? 1 - yes, 2 - no";
    public static final String INVALID_INPUT_E7 = "[E7] input is not correct";
    ...
    public static final String ERROR_USER_NOT_EXIST_E1 = "[E1] User %s does not exist";
    public static final String ERROR_USER_NOT_EXIST_E2 = "[E2] User %s does not exist";
    ...
    public static final String PRINT_PHOTO_PLACEHOLDER = "printPhoto() -> real photo";
    public static final String INSERT_PHOTO_LIKE_ERROR = "insertPhotoLike() -> error";
    public static final String PHOTO_NOT_EXIST = "[Photo %s does not exist]";
    public static final String ALBUM_NOT_EXIST_BRACKET = "[Album %s does not exist]";
    public static final String DEBUG_111 = ">>> 111";
    public static final String DEBUG_222 = ">>> 222";
